---
layout: post
title: "InInstall_Haroopad_In_Ubuntu"
description: ""
category: lesson
tags: [haroopad,install]
---
{% include JB/setup %}
# Ubntu下的Haroopad安装
...
![下载页面](/public/image/2015-12-05-ininstall_haroopad_in_ubuntu-1.png)
...
即可运行
效果如下
![效果图](/public/image/2015-12-05-ininstall_haroopad_in_ubuntu-2.png)
